        ...
        <article className="br3 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-white">
          <main className="pa4 black-80 W-80">
              ...
              <div className="mt4" style={{display:'flex',justifyContent: 'space-evenly'} }>
                <button onClick={toogleModal} className='b br3 pa2 grow pointer hover-white w-40 bg-light-blue b--black-20'>
                  Save
                </button>
                <button className='b br3 pa2 grow pointer hover-white w-40 bg-light-red b--black-20' onClick={toogleModal}>
                  Cancel
                </button>
              </div>
          </main>
