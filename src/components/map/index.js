...
class MapContainer extends Component {
	...
	getModal = () => {
		if (window.localStorage.getItem('acceptAdvisement')) {
			if (window.localStorage.getItem('acceptAdvisement') === 'false') {
				return (
					<Modal>
				...
				<this.Row>
						...
						>
							<div className="panel">
								...
								<SearchFields
									...
									locate={this.locate}
									dataSelected={this.state.optionAcept}
								/>
							</div>
					...
					<this.Column xs="12" sm="12" md="12">
						<this.MapaScroll className="mapa">
							...
							{this.state.isAdvisementOpen && this.getModal()}
						</this.MapaScroll>
					</this.Column>
				</this.Row>
			</div>
